...
la_presion = float(raw_input('Introdusca la presion: '))
la_temperatura = float(raw_input('Introdusca la temperatura: '))
la_humedad = float(raw_input('Introdusca la humedad: '))
la_velocidad = float(raw_input('Introdusca la velocidad del viento: '))
numero_estacion = float(raw_input('Introdusca el numero de estacion: '))
